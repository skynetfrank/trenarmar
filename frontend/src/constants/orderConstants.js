...
export const ORDER_PAYCONFIRM_REQUEST = 'ORDER_PAYCONFIRM_REQUEST';
export const ORDER_PAYCONFIRM_SUCCESS = 'ORDER_PAYCONFIRM_SUCCESS';
export const ORDER_PAYCONFIRM_FAIL = 'ORDER_PAYCONFIRM_FAIL';
export const ORDER_PAYCONFIRM_RESET = 'ORDER_PAYCONFIRM_RESET';